...
en: {
  ...
  section_labels: {
    clarification: "System clarification layer",
    runtime: "Runtime reality",
    failure_patterns: "Structural failure patterns",
    definition: "System definition",
    exclusions: "Explicit exclusions",
    environments: "Intended operating environments",
    domains: "Typical domains",
    delivery: "Delivery structure",
    core: "Core layer",
