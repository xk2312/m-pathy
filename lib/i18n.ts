...
Object.assign(dict.en ?? {}, {
  modes: {
    labels: {
      ...
      love: "Love",
      joy: "Joy",
      peace: "Peace", // reserved for later activation
    },
    descriptions: {
      default: "Resets your field to a neutral baseline, ready for any direction.",
      calm: "Slows your system, clears noise, and brings gentle balance into your mind.",
      flow: "Seamlessly blends all modes into one intuitive stream that anticipates your needs.",
      research: "Cuts through complexity and delivers clear, evidence-based understanding.",
      vision: "Expands your horizon and maps potential paths with strategic foresight.",
      wisdom: "Connects your question to universal knowledge and higher understanding.",
      truth: "Removes noise, reveals the core, and answers with crystalline honesty.",
      council: "Combines multiple perspectives into one coherent, deeply balanced answer.",
      onboarding: "Welcomes you into the system with clarity, structure, and gentle momentum.",
      play: "Generates ideas, sparks imagination, and opens unexpected paths.",
      oracle: "Reveals patterns, hidden connections, and deeper meaning behind your situation.",
      build: "Transforms concepts into concrete output with structure, clarity, and momentum.",
      empathy: "Understands your inner state and responds with warmth, depth, and attunement.",
      love: "Answers with a soft, heart-centered perspective that strengthens your sense of belonging.",
      joy: "Brings brightness, motivation, and emotional clarity to whatever you ask.",
      peace: "", // reserved – fill when PEACE mode goes live
    },
  },
});

// Skeleton for the other 12 locales – keys exist, values fallback to EN
const MODES_EMPTY = {
  modes: {
    labels: {
      default: "",
...
Object.assign(dict.de ?? {}, MODES_EMPTY);
Object.assign(dict.fr ?? {}, MODES_EMPTY);
Object.assign(dict.es ?? {}, MODES_EMPTY);
Object.assign(dict.it ?? {}, MODES_EMPTY);
Object.assign(dict.pt ?? {}, MODES_EMPTY);
Object.assign(dict.nl ?? {}, MODES_EMPTY);
Object.assign(dict.ru ?? {}, MODES_EMPTY);
Object.assign(dict.zh ?? {}, MODES_EMPTY);
Object.assign(dict.ja ?? {}, MODES_EMPTY);
Object.assign(dict.ko ?? {}, MODES_EMPTY);
Object.assign(dict.ar ?? {}, MODES_EMPTY);
Object.assign(dict.hi ?? {}, MODES_EMPTY);
