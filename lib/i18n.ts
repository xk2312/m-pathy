...
export const i18n: Record<string, CouncilLocale> = {
  ...
  fr: {
    council: { items: {
      ...
      "m-ocean": { title:"m-ocean", subtitle:"avec Anthropic Vision",
  ...
  es: {
    council: { items: {
      ...
      "m-power": { title:"m-power", subtitle:"con Colossus",
      ...
      "m-ballance": { title:"m-ballance", subtitle:"con Gemini Apex",
  ...
  pt: {
    council: { items: {
      ...
      "m-ballance":{title:"m-ballance",subtitle:"com Gemini Apex",
