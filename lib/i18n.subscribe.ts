...
export const subscribeDict = {
  ...
  de: {
    subscribe: {
      ...
      cta_aria:
        "Starte einen Monat Zugang zu m-pathy mit bis zu einer Million Tokens für 14,99 Euro.",
  ...
  fr: {
    subscribe: {
      ...
      cta_aria:
        "Démarrer un mois d’accès à m-pathy avec jusqu’à un million de tokens pour 14,99 euros.",
  ...
  es: {
    subscribe: {
      ...
      cta_aria:
        "Iniciar un mes de acceso a m-pathy con hasta un millón de tokens por 14,99 euros.",
  ...
  it: {
    subscribe: {
      ...
      cta_aria:
        "Avvia un mese di accesso a m-pathy con fino a un milione di token per 14,99 euro.",
  ...
  pt: {
    subscribe: {
      ...
      cta_aria:
        "Comece um mês de acesso ao m-pathy com até um milhão de tokens por 14,99 euros.",
  ...
  nl: {
    subscribe: {
      ...
      cta_aria:
        "Start een maand toegang tot m-pathy met tot één miljoen tokens voor 14,99 euro.",
  ...
  ru: {
    subscribe: {
      ...
      cta_aria:
        "Начните месяц доступа к m-pathy с пулом до одного миллиона токенов за 14,99 евро.",
  ...
  zh: {
    subscribe: {
      ...
      cta_aria:
        "以 14,99 欧元获得一个月的 m-pathy 访问权，包含最多一百万 Tokens。",
  ...
  ja: {
    subscribe: {
      ...
      cta_aria:
        "14,99 ユーロで、最大 100 万トークン付きの m-pathy 1 か月アクセスを開始します。",
  ...
  ko: {
    subscribe: {
      ...
      cta_aria:
        "14,99유로에 최대 백만 개의 토큰이 포함된 m-pathy 한 달 이용을 시작합니다.",
  ...
  ar: {
    subscribe: {
      ...
      cta_aria:
        "ابدأ شهرًا من الوصول إلى m-pathy مع ما يصل إلى مليون توكن مقابل 14,99 يورو.",
  ...
  hi: {
    subscribe: {
      ...
      cta_aria:
        "14,99 यूरो में अधिकतम दस लाख टोकन के साथ m-pathy के एक महीने के एक्सेस की शुरुआत करें।",
