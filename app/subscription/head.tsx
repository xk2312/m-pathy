...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "m-pathy — Subscription",
    description:
      "Access 15.000 tokens for € 7,99 and join the operating system for creation.",
  ...
  twitter: {
    ...
    title: "m-pathy — Subscription",
    description: "Access 15.000 tokens for € 7,99 and join the operating system for creation.",
