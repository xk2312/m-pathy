...
function buildServerTelemetryParsed(promptCounter: number): Record<string, string> {
  return {
    ...
    "Drift State": " unknown",
    "Drift Risk": " unknown",
    "Agent Active": " unknown",
    "Agent ID": " unknown",
    "Agent Property": " unknown",
    "Agent Modes": " unknown",
    "Orchestration Mode": " unknown",
    "Orchestrator ID": " unknown",
    "Goal ID": " unknown",
    "Task ID": " unknown",
    "Execution Stage": " unknown",
    "Complexity Level": " unknown",
    "Council Final Status": " unknown",
    "Expert Rights Profile": " unknown",
    "Expert Rights Scope": " unknown",
    "Expert Rights Source": " unknown",
    "Analysis Container State": " unknown",
    "Council Decision ID": " unknown",
    "Domain Resolution Mode": " unknown",
    "Runtime Container ID": " unknown",
    "System State Hash": " unknown"
  };
}
